...
public class GameData {
    ...
    public GameData(String filename){
        ...
        try{
            ...
            if(!file.exists())
                throw new IllegalArgumentException("File " + filename + "doesn't exit");
    ...
    //若可以成功解决, 返回true, 反之false
    private boolean solve(Board board, int turn) {
        if(board == null || turn < 0)
            throw new IllegalArgumentException("Illegal argument in solve function");
